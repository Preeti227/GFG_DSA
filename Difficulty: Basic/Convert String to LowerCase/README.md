<h2><a href="https://www.geeksforgeeks.org/problems/convert-string-to-lowercase/1">Convert String to LowerCase</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a string <strong>s</strong>. The task is to convert string characters to <strong>lowercase</strong>.</span></p>
